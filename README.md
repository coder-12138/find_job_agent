...
```powershell
# Windows PowerShell
$env:PYTHONPATH="src"; python -m job_application_agent_langchain.main
```
...
$env:PYTHONPATH="src"; uvicorn job_application_agent_langchain.web.app:app --host 127.0.0.1 --port 8000
```
